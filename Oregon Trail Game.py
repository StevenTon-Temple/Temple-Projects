            ...
            if choice == "1":
                ...
                if choice == "1":
				    ...
				    print("The air must be knocking you out once again. You fall to the ground. You have failed your mission.\n")
                                    ...
                                    print("The idea is that if you remove 
							the crew quarters it will bring the object with it. The only downside to this is that any belongings you brought onto the ship with you will be lost in space along with the remains
							of your crewmates. You open the airlock from the outside and enter the ship. After closing the door you prepare to reenter the space ship again. You know that you are alone. 
							Communications with HQ have been cut entirely, and the only thing left on the ship besides you is whatever hurt your crewmates. Making your way toward the quarters you can hear 
							something on the inside moving around. It is impossible for it to be a crewmate since the oxygen has been gone for so long, so you decide to make your way to the release point. As 
							You are about to release the crew quarters you hear a voice callout "Help its me Alex!" Knowing everything you saw on the inside of the crew quarters you now have to make a decision.
