...
def actionpart():
    ...
    while True:
        if choice == '1':
            ...
            if choice == "1":
                print("You begin to open the airlock that leads to the crew quarters.")
                print("You feel a tightening in your chest from nerves of what awaits you on the other side.")
                ...
                print("You make your way to the main airlock which leads to the outside of the spacecraft.")
                print("This airlock contains spacesuits normally used for spacewalks.The crew quarters are one of the parts of the ship that has artificial gravity.")
                print("This makes spacesuits unusable there, but since the power is out you can freely travel.")
                print("You put on the space suit and head to the crew quarters.")
                ...
                print("You are now truly alone in space.")
                print("The decisions to save the mission solely rely on you.")
                print("You can continue to search the quarters, or return back to the main floor and contact HQ.\n")
                ...
                if choice == "1":
                    ...
                    if choice == "1":
                        ...
                        if choice == "1":
                            ...
                            print("You also can search the object to find out what it is.\n")
                            ...
                            if choice == "1":
                                ...
                                print("Nearest to this hole look almost like a loading dock of a large cargo plane.")
                                print("You can climb inside and further investigate this object or Head back inside the ship.\n")
